...
function siteIcon(id) {
  const icons = {
    conception: "/media/icons/pernet-option-2/conception.png",
    creation: "/media/icons/pernet-option-2/creation.png",
    renovation: "/media/icons/pernet-option-2/renovation.png",
    terrassement: "/media/icons/pernet-option-2/terrassement.png",
    surfaces: "/media/icons/pernet-option-2/surfaces.png",
    escaliers: "/media/icons/pernet-option-2/escaliers.png",
    plantations: "/media/icons/pernet-option-2/plantations.png",
    gazon: "/media/icons/pernet-option-2/gazon.png",
    entretien: "/media/icons/pernet-option-2/entretien.png",
    "taille-tonte": "/media/icons/pernet-option-2/taille-tonte.png",
    elagage: "/media/icons/pernet-option-2/elagage.png",
    phone: "/media/icons/pernet-option-2/phone.png",
    email: "/media/icons/pernet-option-2/email.png",
    whatsapp: "/media/icons/pernet-option-2/whatsapp.png",
    location: "/media/icons/pernet-option-2/location.png"
  };

  const src = icons[id];
  return src
    ? `<img class="site-icon__image" src="${attr(src)}" alt="" width="256" height="256" loading="lazy" decoding="async" />`
    : "";
}
